...
class GroupChannel extends BaseChannel {
  ...
  Future<PollChangeLogsResponse> getPollChangeLogsSinceTimestamp(int ts, PollChangeLogsParams params) async {
    final sdk = SendbirdSdk().getInternal();
  ...
  Future<PollChangeLogsResponse> getPollChangeLogsSinceToken(String? token, PollChangeLogsParams params) async {
    final sdk = SendbirdSdk().getInternal();
  ...
  static Future<GroupChannel> createChannel(
    ...
    return sdk.api.send<GroupChannel>(GroupChannelCreateRequest(params, onProgress: progress));
  }
  ...
  Future<GroupChannel> updateChannel(
    ...
    return _sdk.api.send<GroupChannel>(GroupChannelUpdateRequest(params, onProgress: progress));
  }
